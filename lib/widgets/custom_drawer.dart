        ...
        child: Padding(
          ...
          child: Column(
            children: [
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('assets/Person-Avatar.png'),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    Positioned(
                      bottom: 10.h,
                      right: 10.w,
                      child: Activation(height: 20, width: 20, borderWidth: 3),
                    ),
                  ],
                ),
              ),
              ...
              CustomButton(
                ...
                buttonBody: Row(
                  ...
                  children: [
                    ...
                    Text('My Cart', style: AppStyles.pharmascan20BoldBlue),
              ...
              CustomButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => DrugsScreen(userModel: userModel),
                    ),
                  );
                },
                buttonColor: AppColors.white,
                buttonBody: Row(
                  ...
                  children: [
                    ...
                    Text('Drugs', style: AppStyles.pharmascan20BoldBlue),
              ...
              CustomButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => OrdersHistory(userModel: userModel),
                    ),
                  );
                },
                buttonColor: AppColors.white,
                buttonBody: Row(
                  ...
                  children: [
                    ...
                    Text('History', style: AppStyles.pharmascan20BoldBlue),
              ...
              Text('DEPI©2025', style: AppStyles.pharmaScan20Weight600White),
              ...
              CustomButton(
                ...
                buttonBody: Row(
                  ...
                  children: [
                    ...
                    Text('Logout', style: AppStyles.pharmascan20BoldBlue),
